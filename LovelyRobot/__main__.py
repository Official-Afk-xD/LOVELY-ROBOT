...
I am Powerfull Management Bot And I Will Help In Managing Your Group.
➖➖➖➖➖➖➖➖➖➖➖➖➖
× *Uptime:* {}
× {} *User, Across* {} *Chats.*
➖➖➖➖➖➖➖➖➖➖➖➖➖
...
def main():
    ...
    about_callback_handler = CallbackQueryHandler(LovelyRobot_about_callback, pattern=r"LovelyRobot_")
