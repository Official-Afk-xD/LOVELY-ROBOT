...
from LovelyRobot.modules.music import download_youtube_audio
from LovelyRobot.utils.functions import test_speedtest
from LovelyRobot.utils.pastebin import paste
...
async def inline_help_func(__HELP__):
    ...
    answerss = [
        InlineQueryResultArticle(
            ...
            thumb_url="https://telegra.ph/file/20af9bae84d4499bdab43.jpg",
...
async def alive_function(answers):
    ...
    buttons.add(
        InlineKeyboardButton("Main bot", url="https://t.me/Blaze_Support"),
        InlineKeyboardButton(
    ...
    msg = f"""
**[Lovely Robot ❤️](https://t.me/The_Blaze_Network):**
**MainBot:** `{bot_state}`
**UserBot:** `{ubot_state}`
